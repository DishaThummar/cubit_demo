...
class LoginView extends StatelessWidget {
        ...
        return Scaffold(
          body: Column(
            ...
            children: [
              ...
              loginWidgest(loginCubit, context),
            ],
          ),
        );
      }),
  ...
  loginWidgest(LoginCubit loginCubit, BuildContext context) {
    return Expanded(
      child: Padding(
            ...
            children: [
              ...
              Text(
                ...
                style: AppTextStyle.regular500.copyWith(
                    fontSize: 15, color: AppColors.blackColor.withOpacity(0.6)),
              ),
              const SizedBox(
                height: 25,
              ),
              ...
              BlocBuilder<LoginCubit, LoginState>(builder: (cubit, state) {
