...
class SignupView extends StatelessWidget {
        ...
        return Scaffold(
          body: Column(
            ...
            children: [
              ...
              signUpWidgest(signUpCubit, context),
            ],
          ),
        );
      }),
  ...
  signUpWidgest(SignupCubit signUpCubit, BuildContext context) {
    return Expanded(
      child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                BlocBuilder<SignupCubit, SignupState>(builder: (cubit, state) {
                ...
                BlocBuilder<SignupCubit, SignupState>(builder: (cubbit, state) {
                ...
                BlocListener<SignupCubit, SignupState>(
                  listener: (cubit, state) {
                    if (state is SignUpApiSuccess || state is SignUpSuccess) {
