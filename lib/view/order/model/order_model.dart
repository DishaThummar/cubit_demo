...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
    ...
    orderDeliveryDatetime: json["order_delivery_datetime"] == null ? null : DateTime.parse(json["order_delivery_datetime"]),
    ...
    orderStatusDisplayText: orderStatusDisplayTextValues.map[json["order_status_display_text"]]!,
    orderStatusDisplay: orderStatusValues.map[json["order_status_display"]]!,
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "order_status_display_text": orderStatusDisplayTextValues.reverse[orderStatusDisplayText],
...
final deliveryTypeValues = EnumValues({
...
final orderModeValues = EnumValues({
  "offline": OrderMode.OFFLINE,
  "online": OrderMode.ONLINE
});
